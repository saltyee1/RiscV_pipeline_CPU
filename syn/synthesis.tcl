...
create_clock -name "CLK" -period 60 -waveform { 30 60 }  { clk  }
...
report_timing -path full -delay min -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group > ../syntiming_min_rpt.txt
...
write -hierarchy -format verilog -output {../syn/trafficlight_syn.v}
write_sdf -version 1.0 -context verilog {../syn/trafficlight_syn.sdf}
write_sdc -version 1.5 {../syn/trafficlight_syn.sdc}
write_script > {../syn/trafficlight_syn.dc}
